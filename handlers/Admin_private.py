...
from database.orm_querry import orm_add_product, orm_get_products, orm_get_product, orm_delete_product, \
    orm_update_product
from filters.chat_tipes import ChatTypeFilter, IsAdmin
...
class AddProduct(StatesGroup):
    ...
    texts = {
        ...
        'AddProduct:image': 'Введите фото товара'
    }
